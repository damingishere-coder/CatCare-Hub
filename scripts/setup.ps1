...
Write-Host "[2/6] Preparing the Python virtual environment..."
...
Write-Host "[4/6] Initializing local access codes..."
...
if ($LASTEXITCODE -ne 0) {
    throw "Local access-code initialization failed."
}
...
Write-Host "[6/6] Installing frontend dependencies..."
