  ...
  return (
    <section className="mx-auto max-w-[1600px]" aria-labelledby="plans-page-title">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <p className="mb-1 text-xs font-semibold tracking-wider text-slate-500 uppercase">P4 · 按天排程</p>
          <h1 id="plans-page-title" className="text-2xl font-semibold tracking-tight">订单计划</h1>
          <p className="mt-2 text-sm leading-6 text-slate-600">按日期安排任务时间和人工路线顺序，并查看当前客户与猫咪要求。</p>
        </div>
