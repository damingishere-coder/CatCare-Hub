...
export function PwaInstallPrompt() {
  ...
  return (
    <section className="mt-4 rounded-xl border border-slate-200 bg-white px-3 py-3" aria-label="安装到手机">
      <div className="flex items-start gap-2.5">
        <Smartphone className="mt-0.5 shrink-0 text-slate-500" size={17} />
        ...
        {promptEvent ? (
          <button
            type="button"
            className="inline-flex min-h-10 shrink-0 items-center gap-1 rounded-lg bg-slate-900 px-3 text-xs font-semibold text-white disabled:opacity-50"
