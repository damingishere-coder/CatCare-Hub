  ...
  return (
    <section className="mt-4 rounded-lg border border-slate-200 bg-white px-3 py-3 shadow-sm" aria-label="安装到手机">
      <div className="flex items-start gap-2.5">
        <Smartphone className="mt-0.5 shrink-0 text-brand-600" size={17} />
        ...
        {promptEvent ? (
          <button
            type="button"
            className="inline-flex min-h-11 shrink-0 items-center gap-1 rounded-xl bg-brand-700 px-3 text-xs font-semibold text-white shadow-sm disabled:opacity-50"
