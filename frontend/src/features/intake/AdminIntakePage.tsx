...
export function AdminIntakePage() {
  ...
  return (
    <section className="mx-auto max-w-[1500px]" aria-labelledby="intake-title">
      ...
      <div className="mt-4 rounded-lg border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm leading-6 text-emerald-900"><strong>安全提示：</strong>后台资料已受管理员会话保护；填写链接只在生成时显示一次，请直接交给对应客户并妥善保管。</div>
