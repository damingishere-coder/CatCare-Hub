...
function StatusPill({ configured, tested = false }: { configured: boolean | undefined; tested?: boolean }) {
  const label = configured === undefined ? "状态未知" : configured ? (tested ? "已连接" : "已配置（未测试）") : "未配置";
